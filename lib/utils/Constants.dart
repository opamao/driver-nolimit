...
const PDF_NAME = 'Nolimit Pro Private Limited';
const PDF_ADDRESS = 'Marcory résidentiel, pharmacie des lagunes';
const PDF_CONTACT_NUMBER = '+225 0585831647';
//endregion

//region Walkthrough
const walk_title1 = "Demander de trajet";
const walk_desc1 =
    "Demande de prise en charge par \nle conducteur le plus proche";

const walk_title2 = "Pickup Rider";
const walk_desc2 =
    "Accepter une demande de transport et \nrécupérer un passager à destination";

const walk_title3 = "Le client";
const walk_desc3 = "Déposer un client à sa destination";
//endregion
